...
export function ProblemAwareness() {
  return (
    <section className="py-24 px-6 bg-white relative overflow-hidden">
      {/* Background Grid */}
      <div className="absolute inset-0 bg-[url('/grid.svg')] bg-center bg-fixed [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))] opacity-[0.05] invert-0" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-8 rounded-3xl bg-red-50/50 border border-red-100"
          >
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-red-900/80 font-medium">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="p-8 rounded-3xl bg-emerald-50/50 border border-emerald-100 relative shadow-sm"
          >
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-emerald-900/80 font-medium">
